...
export default async function Layout({
	...
	return (
		<html lang="en">
			...
			>
				<header className="flex flex-row justify-between items-center z-10 fixed top-0 py-2 left-16 right-16 lg:left-32 lg:right-32 bg-background">
					<Logo />
				...
				<div className="py-16 lg:py-24 space-y-4 w-full flex flex-col items-center">
					<TabContainer promise={tabs} />
					{children}
				</div>
			</body>
		</html>
...
function Logo() {
	return (
		<div className="mt-4 ml-4 flex flex-row gap-2 items-center">
			...
			<span className="tracking-tighter font-medium">New</span>
		</div>
	);
}
